...
resource "azurerm_linux_web_app" "example2" {
  ...
  location            = var.location
  service_plan_id     = var.service_plan_id
  virtual_network_subnet_id = "/subscriptions/d7362f78-3fd1-413c-8adc-149b8f3446c8/resourceGroups/rsg-uat-network-ci-001/providers/Microsoft.Network/virtualNetworks/vnt-uat-ci-001/subnets/snt-uat-storagepe-ci-004"
